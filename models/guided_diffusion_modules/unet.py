...
# from module_test.b24_agent import *
# from module_test.ms_mean_la import *


from module_test.a41_mlla_kan import *
# from module_test.a41_mlla_kan_modify import *

# from module_test.ms_mean_a41_mlla_kan import *
...
class UNet(nn.Module):
    ...
    def __init__(
        ...
        self.middle_block1 = EmbedSequential(
            ResBlock(
                ch,
                cond_embed_dim,
                dropout,
        ...
        # self.middle_block2 = EmbedSequential(
        #     AttentionBlock(
        #         ch,
        #         use_checkpoint=use_checkpoint,
        #         num_heads=num_heads,
        ...
        #     ))
            ...
            # AgentAttention(dim=ch),
        # self.middle_block2 = AgentAttention(dim=ch, num_patches=1024)
        self.middle_block2 = EmbedSequential(
            # MultiLevelSCSA_scaler(dim=ch)
            MKLAttention(ch)
        )
        ...
        # DynamicMSPABlock(inplanes=ch),
            ...
            # MultiScaleFeatureFusion(dim=ch),
            # CBAM(ch),
        self.middle_block3 = EmbedSequential(
            ResBlock(
                ch,
                cond_embed_dim,
                dropout,
    ...
    def forward(self, x, gammas):
        ...
        # h = self.middle_block2(h, 32, 32)
        h = self.middle_block2(h, emb)
        h = self.middle_block3(h, emb)
